		...
		<ul class="caption-style-2">
            ...
            */
            ...
            function findAll(){
                ...
                $result=mysqli_query($db,$query);
                while($row = $result->fetch_assoc()) {
                    $li="<li><a href='detail.php?id=".$row['ImageID']."' class='img-responsive'>";
                    $li.="<img src='images/square-medium/".$row['Path']."' alt='".$row['Title']."'/>";
                    $li.="<div class=\"caption\"><div class=\"blur\"></div><div class=\"caption-text\"><p>".$row['Description']."</p></div></div></a></li>";
                    echo $li;
                }
                $query=null;
                $result->close();
           ...
           Please try again later.</p>';
            ...
            function findByCC($country,$continent){
                $db=new mysqli('localhost','root','','travel');
                if (mysqli_connect_errno()){
                    echo'<p>Error:Could not connect to database.<br/>
           Please try again later.</p>';
