...
//           $N=${"images"};
//           reset($N);
//           while(list($key,$id,$title,$description,$country,$city,$user,$path,$taken,$tags)=each($N)){
//               $div0="";
//               $div0.="<li><a href='detail.php?id=".$id."' class=\"img-responsive\">";
//              $div0.="<img src='images/square/".$path."' alt='".$title."'>";
//              $div0.="<div class=\"caption\"><div class=\"blur\"></div><div class=\"caption-text\"><h1>".$title."</h1></div></div></a>";
//              $div0.="</li>";
//               echo $div0;
//           }
          $div0="";
